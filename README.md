# <img alt="Logo da WinToken" src="assets-doc\logo.png" width="50%">

## Team Members
- <a href="https://www.linkedin.com/in/jonathanteoalves/">Jonathan Teodoro</a>
- <a href="https://www.linkedin.com/in/lucas-nepomuceno-ismart/">Lucas Nepomuceno</a>
- <a href="https://www.linkedin.com/in/thiagogomesalmeida/">Thiago Gomes</a>
- <a href="https://www.linkedin.com/in/tiago-vsant/">Tiago dos Santos</a>
...
<img alt='Persona "Casual, Joshua"' src='assets-doc/Persona - WinToken.png'>
...
&nbsp;&nbsp;&nbsp;&nbsp; With the image above, it is clear that our solution focus on solving the "boring streaming" problem, making it more engageful to the viewer to watch a four hours match. Offering a NFT and non-monetary-bidding as the main products. The aim of WinToken is to engage the user with the idea of obtaining a prize, such as a NFT, just for watching a basketball, soccer or any sport streaming and bidding with digital coins without cost.  
...
- <b>.vite/:</b> Directory containing configuration and cache files used by Vite.js during development. The /deps directory relates to dependencies or dependency caching.
- <b>assets-doc:</b> Directory containing documentation-related assets.
- <b>src:</b> Main directory where source code resides, including JavaScript, CSS, or other assets compiled and bundled by Vite.js during the build process.
- <b>README.md:</b> Markdown file containing documentation or information about the project, providing instructions on usage, purpose, installation, etc.
- <b>index.html:</b> Main HTML file of the web application, serving as the entry point and including links to JavaScript and CSS files.
- <b>package-lock.json:</b> File generated by npm to lock down dependency versions in node_modules, ensuring consistent installations across different machines.
