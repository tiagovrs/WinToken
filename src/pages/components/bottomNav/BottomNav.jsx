...
export default function BottomNav() {
  ...
  return (
    ...
    <Link to="/loja" className={`navBtn ${useLocation().pathname === '/loja' ? 'selected' : ''}`}>
      <FontAwesomeIcon className="btnIcon" icon={faStore} />
      <p>Loja</p>
    </Link>

    <Link to="/scan" className={`navBtn ${useLocation().pathname === '/scan' ? 'selected' : ''}`}>
      <FontAwesomeIcon className="btnIcon" icon={faQrcode} />
      <p>Ler</p>
    </Link>

    <Link to="/apostas" className={`navBtn ${useLocation().pathname === '/apostas' ? 'selected' : ''}`}>
